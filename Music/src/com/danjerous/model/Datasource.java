...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\Danier Javid\\Desktop\\Courses\\java-masterclass\\Music\\" + DB_NAME;
    ...
    public static final int INDEX_NAME_ARTIST = 2;
    ...
    public static final String QUERY_ALBUMS_BY_ARTIST_START =
            "SELECT " + TABLE_ALBUMS + "." + COLUMN_ALBUM_NAME + " FROM " + TABLE_ALBUMS + " INNER JOIN " + TABLE_ARTISTS + " ON " + TABLE_ALBUMS + "." + COLUMN_ALBUM_ARTIST + " = " + TABLE_ARTISTS + "." + COLUMN_ARTIST_ID + " WHERE " + TABLE_ARTISTS + "." + COLUMN_ALBUM_NAME + " = \"";
    ...
    public static final String QUERY_INSERT_ARTITS = "INSERT INTO " + TABLE_ARTISTS + " (" + COLUMN_ARTIST_NAME + ") VALUES (?)";

    public static final String QUERY_INSERT_ALBUMS = "INSERT INTO " + TABLE_ALBUMS + " (" + COLUMN_ALBUM_NAME + ", " + COLUMN_ALBUM_ARTIST + ") VALUES (?, ?)";

    public static final String QUERY_INSERT_SONGS = "INSERT INTO " + TABLE_SONGS + " (" + COLUMN_SONG_TRACK + ", " + COLUMN_SONG_TITLE+ ", " + COLUMN_SONG_ALBUM +") VALUES (?, ?, ?)";
    ...
    public boolean open() {
        try {
            ...
            insertIntoArtists = conn.prepareStatement(QUERY_INSERT_ARTITS, Statement.RETURN_GENERATED_KEYS);

            insertIntoAlbums = conn.prepareStatement(QUERY_INSERT_ALBUMS, Statement.RETURN_GENERATED_KEYS);

            insertIntoSongs = conn.prepareStatement(QUERY_INSERT_SONGS);
    ...
    public void insertSong(String title, String artist, String album, int track) {
        ...
        try {
            ...
            if (affectedRows == 1) {
                conn.commit();
                System.out.println("Song [" + title +"] inserted.");
            } else {
            ...
            try {
                ...
                System.out.println("Oh boy! Things are really bad" + ee.getMessage());
                 ee.printStackTrace();
            }
        } finally {
            try {
